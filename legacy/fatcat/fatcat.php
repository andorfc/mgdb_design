...
/* file: fatcat.php
 *
 * purpose: display fatcat
 *
 * history:
 *  9/7/22  jportwood  created initial fatcat page
 */			
  ...
  $fatcat = $mgdb->get('body')->load('templates/tools/fatcat.bau');
  $fatcat->get('fatcat-content')->get('uniprot_id')->replace($uniprot_id);
?>
