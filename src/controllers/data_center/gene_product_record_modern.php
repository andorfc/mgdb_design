...
$bauplan->head(MgdbJsonLd::headMarkup('gene_product', $gene_product_id, array(
  'name' => $product_name, 'description' => $summary,
  'attributes' => array('product_type' => $identity['type'], 'species' => $identity['species']))));
MgdbJsonLd::signpost('gene_product', $gene_product_id);
