...
$bauplan->head(MgdbJsonLd::headMarkup('map_scores', $record_id, array(
  'name' => $record_name, 'description' => $summary,
  'attributes' => array('probed_site' => $identity['probed_site'], 'linkage_group' => $identity['linkage_group']))));
MgdbJsonLd::signpost('map_scores', $record_id);
