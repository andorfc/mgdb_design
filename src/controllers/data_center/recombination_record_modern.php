...
$bauplan->head(MgdbJsonLd::headMarkup('recombination', $record_id, array(
  'name' => $record_name, 'description' => $summary,
  'attributes' => array('cross_type' => $identity['cross_type'], 'total_progeny' => $identity['total_progeny']))));
MgdbJsonLd::signpost('recombination', $record_id);
