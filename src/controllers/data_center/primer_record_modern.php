...
$bauplan->head(MgdbJsonLd::headMarkup('primer', $record_id, array(
  'name' => $record_name, 'description' => $summary,
  'attributes' => array('primer_type' => $identity['type'], 'sequence' => $identity['sequence']))));
MgdbJsonLd::signpost('primer', $record_id);
