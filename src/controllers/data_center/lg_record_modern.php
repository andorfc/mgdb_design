...
$bauplan->head(MgdbJsonLd::headMarkup('linkage_group', $lg_id, array(
  'name' => $lg_display, 'description' => $summary,
  'attributes' => array('type' => $identity['type'], 'species' => $identity['species'], 'map_count' => $identity['map_count']))));
MgdbJsonLd::signpost('linkage_group', $lg_id);
