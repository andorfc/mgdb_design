...
$bauplan->head(MgdbJsonLd::headMarkup('gel', $record_id, array(
  'name' => $record_name, 'description' => $summary,
  'attributes' => array('probe' => $identity['probe'], 'enzyme' => $identity['enzyme'], 'stock' => $identity['stock']))));
MgdbJsonLd::signpost('gel', $record_id);
