<?PHP
/* file: Reaction_functions.php
 *
 * purpose: helper functions for displaying a Reaction record.
 *
 * history:
...
function check_id($id, $DBConn) {
  ...
  $query = "SELECT a.name from reaction a, id_num b where b.curation_lvl = 0 and a.id = b.id and a.ID = " . $iid;
