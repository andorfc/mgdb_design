...
$bauplan->head(MgdbJsonLd::headMarkup('phenotype', $phenotype_id, array(
  'name' => $phenotype_name, 'description' => $summary,
  'attributes' => array('trait' => $identity['trait'], 'value' => $identity['value']))));
MgdbJsonLd::signpost('phenotype', $phenotype_id);
