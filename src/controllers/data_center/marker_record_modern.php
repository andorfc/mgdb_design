...
$bauplan->head(MgdbJsonLd::headMarkup('marker', $marker_id, array(
  'name' => $marker_name, 'description' => $summary,
  'attributes' => array('marker_type' => $identity['type']))));
MgdbJsonLd::signpost('marker', $marker_id);
