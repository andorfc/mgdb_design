...
$bauplan->head(MgdbJsonLd::headMarkup('locus', $locus_id, array(
  'name' => $locus_name, 'description' => $summary,
  'attributes' => array('full_name' => $identity['full_name'], 'locus_type' => $identity['type'], 'linkage_group' => $identity['linkage_group']))));
MgdbJsonLd::signpost('locus', $locus_id);
