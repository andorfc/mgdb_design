...
$bauplan->head(MgdbJsonLd::headMarkup('term', $term_id, array(
  'name' => $term_name, 'description' => $summary,
  'attributes' => array('term_type' => $identity['type'], 'is_trait' => $is_trait))));
MgdbJsonLd::signpost('term', $term_id);
