...
/* file: gel.php
 *
 * purpose: convenience redirect. /gel -> /data_center/gel, the canonical
 *          gel pattern record route, preserving the record id whether it
 *          arrives as ?id=<id> or as the path segment /gel/<id>.
 *
 ...
 * external bookmark of /gel resolves. controller.php checks
 ...
 */
  ...
  $dest = '/data_center/gel';

  /* /gel/<id> path form: the id is the segment after the controller name. */
