<?PHP
/* Retired 2026-09-07 (Carson). /community/jobs redirects to /jobs.
 *
 * Two routes reached this page: controller.php sends /jobs to
 * controllers/jobs.php, which is modern, while controllers/community.php
 * dispatches /community/jobs here, to the pre-redesign version. So the old
 * page went on serving at a second URL after the community job board was rebuilt.
 *
 * The modern page carries the same three listings and a submission form with
 * an identical field set -- ContactName, ContactEmail, JobTitle, Location,
 * DegreeRequired, AreaOfStudy, Responsibilities, OtherRequirements,
 * OtherNotes, ApplyBy_day/month/year, SubmitJob.
 *
 * The original code is left below, untouched. Rollback: delete this block
 * and the redirect under it.
 */

  header('Location: /jobs', true, 301);
  exit;
