...
/* file: trait.php
 *
 * purpose: convenience redirect. /trait -> /data_center/trait, the canonical
 *          trait record route, preserving the record id whether it arrives as
 *          ?id=<id> or as the path segment /trait/<id>.
 *
 ...
 * external bookmark of /trait resolves. controller.php checks
 ...
 */
  ...
  $dest = '/data_center/trait';

  /* /trait/<id> path form: the id is the segment after the controller name. */
