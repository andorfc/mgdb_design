...
/* file: term.php
 *
 * purpose: convenience redirect. /term -> /data_center/term, the canonical
 *          term record route, preserving the record id whether it arrives as
 *          ?id=<id> or as the path segment /term/<id>.
 *
 ...
 * external bookmark of /term resolves. controller.php checks
 ...
 */
  ...
  $dest = '/data_center/term';

  /* /term/<id> path form: the id is the segment after the controller name. */
