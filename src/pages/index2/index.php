<?php
/*
 * file: index2/index.php  --  homepage design alternative 2
 *
 ...
 *
 * Version 2 differs by: templates/static/mgdb_home2.bau plus the
 * .mgdb-home-v2 rules in css/mgdb-home-alt.css.
 *
...
logMessage('Starting index2/index.php');
...
$bauplan = new Bauplan('MaizeGDB — Maize Genetics and Genomics Database (design 2)');
$bauplan->modern();
...
$content = $mgdb->get('body')->load('templates/static/mgdb_home2.bau');
chdir($cwd);
