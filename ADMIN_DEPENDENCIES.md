...
70 entries have been raised. **58 are open** and **12 are closed** — applied, implemented, or recorded as needing no administrator at all. Regenerated by `tools/admin_index.py` on 2026-09-11; the entry is always the authority, this table is only a way in.
