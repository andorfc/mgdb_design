(function () {
  ...
  var attendance = {
    labels: ['2000','2001','2002','2003','2004','2005','2006','2007','2008','2009','2010','2011','2012','2013','2014','2015','2016','2017','2018','2019','v2020','2021','2022','2023','2024','2025','2026'],
  ...
  var archives = [
    {year:'2025', annual:67, location:'St. Louis, Missouri', url:'/mgc/maizemeeting/2025'},
    {year:'2024', annual:66, location:'Raleigh, North Carolina', url:'/mgc/maizemeeting/2024'},
    {year:'2023', annual:65, location:'St. Louis, Missouri', url:'/mgc/maizemeeting/2023'},
    {year:'2022', annual:64, location:'St. Louis, Missouri', url:'/mgc/maizemeeting/2022'},
    {year:'2021', annual:63, location:'Virtual', url:'/mgc/maizemeeting/2021'},
    {year:'v2020', annual:62, location:'Virtual', url:'/maize_meeting/v2020', note:'virtual meeting'},
    {year:'2020', annual:62, location:'Keauhou Bay, Hawaii', url:'/maize_meeting/2020', note:'planned in-person meeting · canceled'},
    {year:'2019', annual:61, location:'St. Louis, Missouri', url:'/maize_meeting/2019'},
    {year:'2018', annual:60, location:'Saint-Malo, France', url:'/maize_meeting/2018'},
    {year:'2017', annual:59, location:'St. Louis, Missouri', url:'/maize_meeting/2017'},
    {year:'2016', annual:58, location:'Jacksonville, Florida', url:'/maize_meeting/2016'},
    {year:'2015', annual:57, location:'St. Charles, Illinois', url:'/maize_meeting/2015'},
    {year:'2014', annual:56, location:'Beijing, China', url:'/maize_meeting/2014'},
    {year:'2013', annual:55, location:'St. Charles, Illinois', url:'/maize_meeting/2013'},
    {year:'2012', annual:54, location:'Portland, Oregon', url:'/maize_meeting/2012'},
    {year:'2011', annual:53, location:'St. Charles, Illinois', url:'/maize_meeting/2011'},
    {year:'2010', annual:52, location:'Riva del Garda, Italy', url:'/maize_meeting/2010'},
    {year:'2009', annual:51, location:'St. Charles, Illinois', url:'/maize_meeting/2009'},
    {year:'2008', annual:50, location:'Washington, DC', url:'/maize_meeting/2008'},
    {year:'2007', annual:49, location:'St. Charles, Illinois', url:'/maize_meeting/2007'},
    {year:'2006', annual:48, location:'Pacific Grove, California', url:'/maize_meeting/2006'},
    {year:'2005', annual:47, location:'Lake Geneva, Wisconsin', url:'/maize_meeting/2005'},
    {year:'2004', annual:46, location:'Mexico City, Mexico', url:'/maize_meeting/2004'},
    {year:'2003', annual:45, location:'Lake Geneva, Wisconsin', url:'/maize_meeting/2003'},
    {year:'2002', annual:44, location:'Kissimmee, Florida', url:'/maize_meeting/2002'},
    {year:'2001', annual:43, location:'Lake Geneva, Wisconsin', url:'/maize_meeting/2001'},
    {year:'2000', annual:42, location:"Coeur d'Alene, Idaho", url:'/maize_meeting/2000'},
    {year:'1999', annual:41, location:'Lake Geneva, Wisconsin', url:'/maize_meeting/1999'},
    {year:'1998', annual:40, location:'Lake Geneva, Wisconsin', url:'/maize_meeting/1998'},
    {year:'1997', annual:39, location:'Clearwater Beach, Florida', url:'/maize_meeting/1997'},
    {year:'1959', annual:1, location:'Allerton Park, Illinois', url:'/maize_meeting/1959', note:'original-meeting mock-up'}
  ];
  ...
  function renderArchive() {
    ...
    grid.innerHTML = visible.map(function (row) {
      ...
      return '<a href="' + row.url + '"><span>' + row.year + '</span><strong>' + row.location + '</strong><small>' + note + '</small></a>';
    }).join('');
  ...
  function renderCharts() {
    ...
    document.querySelectorAll('.meeting-chart-fallback').forEach(function (fallback) { fallback.remove(); });
    var config = {displayModeBar: false, responsive: true};

    var attendanceLayout = baseLayout();
    attendanceLayout.margin = {l: 44, r: 12, t: 30, b: 48};
    attendanceLayout.xaxis = {fixedrange: true, tickangle: -45, tickfont: {size: 8}, showgrid: false};
    ...
    Plotly.react('meeting-attendance-chart', [
      ...
      {type:'scatter', mode:'markers', name:'Virtual', x:['v2020','2021'], y:[670,721], text:['Virtual','Virtual'],
        marker:{color:'#c82c22', size:9, symbol:'diamond', line:{color:'#fff', width:1}},
        hovertemplate:'<b>%{x}</b><br>Virtual meeting<br>%{y:,} attendees<extra></extra>'}
    ], attendanceLayout, config);

    var programLayout = baseLayout();
    programLayout.margin = {l: 44, r: 12, t: 30, b: 48};
    programLayout.barmode = 'stack';
    programLayout.xaxis = {fixedrange: true, tickangle: -45, tickfont: {size: 8}, showgrid: false};
    programLayout.yaxis = {fixedrange: true, rangemode: 'tozero', gridcolor: '#eee8df', title: 'Presentations'};
    Plotly.react('meeting-program-chart', [
